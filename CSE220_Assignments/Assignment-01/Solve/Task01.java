...
public class Task01 {
    ...
    public static void main(String[] args) {
        int x = (1910%33) + (1077%34) ;
        int[] a = {x-18, x+4, x, x+14, x-5, x+4, x-2, x+9};

        System.out.println("\n///// TEST 01: Copy Array example /////");
        int[] b = copyArray(a, a.length);
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 

//        System.out.println("\n///// TEST 02: Print Reverse example /////");
//        printArray(a); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 
//        printReverse(a); // This Should Print: { 61, 50, 56, 47, 66, 52, 56, 34 } 

        System.out.println("\n///// TEST 02: Resize Array example /////");
        b = copyArray(a, a.length);
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 
        b = resizeArray(b, 10);
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61, 0, 0 }

        System.out.println("\n///// TEST 03: Reverse Array example /////");
        b = copyArray(a, a.length);
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 
        reverseArray(b);
        printArray(b); // This Should Print: { 61, 50, 56, 47, 66, 52, 56, 34 } 

        System.out.println("\n///// TEST 04: Shift Left k cell example /////");
        b = copyArray(a, a.length);
        printArray(b);
        b = shiftLeft(b, 3);
        printArray(b); // This Should Print: { 66, 47, 56, 50, 61, 0, 0, 0 } 

        System.out.println("\n///// TEST 05: Shift Right k cell example /////");
        b = copyArray(a, a.length);
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 
        b = shiftRight(b, 3);
        printArray(b);  // This Should Print: { 0, 0, 0, 34, 56, 52, 50, 61 } 
        ...
        printArray(b); // This Should Print: { 34, 56, 52, 66, 47, 56, 50, 61 } 
        b = rotateRight(b, 4);
        printArray(b); // This Should Print: { 47, 56, 50, 61, 34, 56, 52, 66 } 
        ...
        printArray(b); // This Should Print: { 34, 56, 70, 52, 66, 47, 56, 50 } 
        ...
        System.out.println(bol); // This Should Print: true
        printArray(b); // This Should Print: { 10, 20, 70, 30, 40, 50, 70 } 

        System.out.println("\n///// TEST 11: Remove example 1 /////");

        printArray(b); // This Should Print: { 10, 20, 70, 30, 40, 50, 70 } 
        bol = removeAll(b, 7, 90);
        System.out.println(bol); // This Should Print: false
        printArray(b); // This Should Print: { 10, 20, 70, 30, 40, 50, 70 } 

        System.out.println("\n///// TEST 12: Remove example 2 /////");
        printArray(b);  // This Should Print: { 10, 20, 70, 30, 40, 50, 70 } 
        bol = removeAll(b, 7, 70);
        System.out.println(bol); // This Should Print: true
        printArray(b);  // This Should Print: { 10, 20, 30, 40, 50, 0, 0 } 
